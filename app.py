...
# ==============================================================================
MY_STOPWORDS = [
    "တာမျိုးရှိ", "တာမျိုး", "မျိုးရှိ", "ဖြစ်နေတာ", "ဖြစ်တယ်", "ဖြစ်လို့",
    "နေတယ်", "နေတာ", "တယ်", "သည်", "တာ", "ခြင်း", "လွန်းလို့", 
    "အရမ်း", "ရမ်း", "ရတာ", "တွေ", "မအီမသာ", "နေပါတယ်", "ပါတယ်", 
    "များ", "ကြီး", "ရှိ", "မရှိဘူး", "မရှိ", "မပါဘူး", "မပါ", "မဟုတ်ဘူး", 
    "မဟုတ်", "မဖျား", "သလိုပဲ", "သလို"
]
